/**
 * A container for the [market](https://esi.tech.ccp.is/latest/#/Market) ESI
...
module.exports = function(api) {
  ...
  /**
   * Get a page of market orders in the given region from the ESI endpoint.
   * Orders include buy and sell, and are for any item type. This makes an HTTP
   * GET request to
  ...
  /**
   * Get all market orders in the given region for the given item type from the
  ...
  /**
   * Get all buy market orders in the given region for the particular item type.
   * This is equivalent to {@link module:market.getOrdersFor getOrdersFor}
