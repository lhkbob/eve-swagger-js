/**
 * A container for the [user interface](https://esi.tech.ccp.is/latest/#/User_Interface)
 ...
 */
 module.exports = function(api) {
     ...
     * HTTP POST request to [`/ui/autopilot/waypoint/`](https://esi.tech.ccp.is/latest/#!/User_Interface/post_ui_autopilot_waypoint).
    ...
    exports.setWaypoint = function(destinationId, accessToken) {
        var opts = { clearOtherWaypoints: true,
                     addToBeginning: true };
     ...
     * an  HTTP POST request to [`/ui/autopilot/waypoint/`](https://esi.tech.ccp.is/latest/#!/User_Interface/post_ui_autopilot_waypoint).
     * The request is returned as an asynchronous Promise that resolves to 
     * an empty object on success. 
     *
    ...
    exports.appendWaypoint = function(destinationId, accessToken) {
        var opts = { clearOtherWaypoints: false,
    ...
    /**
     * Insert a waypoint to the in-game autopilot with the ESI endpoint. This makes 
     * an  HTTP POST request to [`/ui/autopilot/waypoint/`](https://esi.tech.ccp.is/latest/#!/User_Interface/post_ui_autopilot_waypoint).
     * The request is returned as an asynchronous Promise that resolves to 
     * an empty object on success. 
     *
    ...
    exports.openInfo = function(id, accessToken) {
        return newRequest(ESI.UserInterfaceApi, 'postOpenwindowInformation',
                          [id], accessToken);
    };

    /**
     * Open the in-game market window to the specified type via the ESI 
     * endpoint. This makes an  HTTP POST request to 
    ...
    /**
     * Open the in-game mail window to send a new mail via the ESI 
     * endpoint. This makes an  HTTP POST request to 
     * [`/ui/openwindow/contract/`](https://esi.tech.ccp.is/latest/#!/User_Interface/post_ui_openwindow_newmail).
     * The request is returned as an asynchronous Promise that resolves to 
     * an empty object on success. The new mail dialog is initialized based on
     * the mail configuration passed in, an example of which looks like:
     * 
     * ```
     * {
     *   "body": "string",
    ...
    exports.openNewMail = function(mail, accessToken) {
        return newRequest(ESI.UserInterfaceApi, 'postUiOpenwindowNewmail',
                          [mail], accessToken);
    };
