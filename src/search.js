/**
 * A container for the [search](https://esi.tech.ccp.is/latest/#/Search)
 ...
 */
 module.exports = function(api) {
    ...
    /**
     * Search constructor that configures the 'strict' policy for all
    ...
    /**
     * Get the search results from the ESI endpoint that match the given
     * query `text`, restricted to the `categories` set (stored as an
     * array). The optional `language` parameter can be used to define the
     * language and locale of the query's text. If `categories` is `null`,
     * `undefined`, or empty then all categories are queried.
     *
     * This makes an HTTP GET request to [`/search/`](https://esi.tech.ccp.is/latest/#!/Search/get_search).
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all agents in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['agent']`. Note that the resolved response 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all alliances in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['alliance']`. Note that the resolved response 
     * object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all characters in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['character']`. Note that the resolved response 
     * object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all constellations in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['constellation']`. Note that the resolved 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all corporations in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['corporation']`. Note that the resolved 
     * response object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all factions in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['faction']`. Note that the resolved response 
     * object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all item types in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['inventoryType']`. Note that the resolved 
     * response object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all regions in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['region']`. Note that the resolved response 
     * object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all solar systems in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['solarsystem']`. Note that the resolved 
     * response object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all stations in EVE. This is equivalent to a call to {@link module:search.get get} 
     * with the category set to `['station']`. Note that the resolved response 
     * object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
    ...
    /**
     * Get the search results from the ESI endpoint for the query `text` over
     * all wormhole categories in EVE. This is equivalent to a call to
     * {@link module:search.get get} with the category set to `['wormhole']`. 
     * Note that the resolved response object still includes the type specifier.
     *
     * @param {String} text The search terms of the query
     * @param {String} language Optional language code of the query. If not 
     *   provided it defaults to the language specified in the factory or 
