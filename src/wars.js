/**
 * A container for the [wars](https://esi.tech.ccp.is/latest/#/Wars)
 ...
 */
 module.exports = function(api) {
    ...
    /**
     * Get ids of all wars from the ESI endpoint. This makes
     * an HTTP GET request to [`/wars/`](https://esi.tech.ccp.is/latest/#!/Wars/get_wars).
    ...
    /**
     * Get information on a war from the ESI endpoint. This makes
     * an HTTP GET request to [`/wars/{id}/`](https://esi.tech.ccp.is/latest/#!/Wars/get_wars_war_id).
     * The request is returned as an asynchronous Promise that resolves to 
     * an array parsed from the response JSON model. An example value looks 
     * like:
     * ```
    ...
    /**
     * Get killmail ids from a war from the ESI endpoint. This makes
     * an HTTP GET request to [`/wars/{id}/killmails/`](https://esi.tech.ccp.is/latest/#!/Wars/get_wars_war_id_killmails).
     * The request is returned as an asynchronous Promise that resolves to 
     * an array parsed from the response JSON model. An example value looks 
     * like:
     * ```
