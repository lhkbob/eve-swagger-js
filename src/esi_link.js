/*
 * Define an esi_link tag. This is a bit of a hack but it allows us to include
 * a link to a relative path (which jsdoc fails to recognize as a valid URL),
 * and it doesn't require modifying a template. Additionally, by adding directly
 * to the description, it works when docs are generated as markdown.
 *
...
exports.defineTags = function(dictionary) {
    dictionary.defineTag('esi_link', {
        ...
        onTagged: function(doclet, tag) {
            ...
            var linkText = '\nThis promisifies a call to the generated [' 
                + value + '](' + url + ').';
