/**
 * A container for the [industry](https://esi.tech.ccp.is/latest/#/Industry)
 ...
 */
 module.exports = function(api) {
     ...
     * request to [`/industry/facilities`](https://esi.tech.ccp.is/latest/#!/Industry/get_industry_facilities).
     ...
     * an HTTP GET request to [`/industry/systems`](https://esi.tech.ccp.is/latest/#!/Industry/get_industry_systems).
     * The request is returned as an asynchronous Promise that resolves to 
     * an array parsed from the response JSON model. An example value looks 
     * like:
     * ```
