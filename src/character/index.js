...
module.exports = function(api) {
  ...
  /**
   * This is an instance of `calendar` module configured to use the options
  ...
  exports.getPortraits = function(id) {
    return newRequest(ESI.CharacterApi, 'getCharactersCharacterIdPortraits',
        [id]);
  };
  ...
  exports.getAssets = function(id, accessToken) {
    return newRequest(ESI.AssetsApi, 'getCharactersCharacterIdAssets', [id],
        accessToken);
  };

  /**
   * Get a character's personal bookmarks from the ESI endpoint. This makes an
   * HTTP GET request to
  ...
  /**
   * Get a character's bookmark folders from the ESI endpoint. This makes an
   * HTTP GET request to
  ...
  exports.getBookmarkFolders = function(id, accessToken) {
    return newRequest(ESI.BookmarksApi,
        'getCharactersCharacterIdBookmarksFolders', [id], accessToken);
  };
  ...
  exports.getClones = function(id, accessToken) {
    return newRequest(ESI.ClonesApi, 'getCharactersCharacterIdClones', [id],
        accessToken);
  };

  /**
   * Get recent kill mails for the given character via the ESI end point. Up to
   * `maxCount` mail ids and hashes will be returned, or up to 50 if the count
   * is not provided. Pagination is supported by specifying `maxKillId`, in
   * which case the most recent mails prior to the max id will be returned.
   *
  ...
  exports.getKillmails = function(characterId, accessToken, maxKillId,
    ...
    return newRequestOpt(ESI.KillmailsApi,
        'getCharactersCharacterIdKillmailsRecent', [characterId], opts,
        accessToken);
  };

  /**
   * Get a character's location from the ESI endpoint. This makes an HTTP GET
   * request to
  ...
  exports.getLocation = function(id, accessToken) {
    return newRequest(ESI.LocationApi, 'getCharactersCharacterIdLocation', [id],
        accessToken);
  };
  ...
  exports.getShip = function(id, accessToken) {
    return newRequest(ESI.LocationApi, 'getCharactersCharacterIdShip', [id],
        accessToken);
  };
  ...
  exports.getColonies = function(id, accessToken) {
    return newRequest(ESI.PlanetaryInteractionApi,
        'getCharactersCharacterIdPlanets', [id], accessToken);
  };
  ...
  exports.getColonyLayout = function(characterId, planetId, accessToken) {
    return newRequest(ESI.PlanetaryInteractionApi,
        'getCharactersCharacterIdPlanetsPlanetId', [id], accessToken);
  };
  ...
  exports.getSkillQueue = function(id, accessToken) {
    return newRequest(ESI.SkillsApi, 'getCharactersCharacterIdSkillqueue', [id],
        accessToken);
  };
  ...
  exports.getSkills = function(id, accessToken) {
    return newRequest(ESI.SkillsApi, 'getCharactersCharacterIdSkills', [id],
        accessToken);
  };
  ...
  exports.getWallets = function(id, accessToken) {
    return newRequest(ESI.WalletApi, 'getCharactersCharacterIdWallets', [id],
        accessToken);
  };
