/**
 * A container for the [contacts](https://esi.tech.ccp.is/latest/#/Contacts) ESI
...
module.exports = function(api) {
  ...
  /**
   * Get a page of contacts for the given character via the ESI end point. The
   * `page` parameter controls which page is selected. This makes an HTTP GET
   * request to
  ...
  exports.get = function(id, page, accessToken) {
    return newRequestOpt(ESI.ContactsApi, 'getCharactersCharacterIdContacts',
        [id], { page: page }, accessToken);
  };

  /**
   * Remove contacts by their id from the given character's contact list via the
   * ESI end point. This makes an HTTP DELETE request to
  ...
  exports.remove = function(characterId, contacts, accessToken) {
    return newRequest(ESI.ContactsApi, 'deleteCharactersCharacterIdContacts',
        [characterId, contacts], accessToken);
  };

  var bulkAddContacts = function(characterId, contacts, standing, watched,
      label, accessToken) {
    ...
    return newRequestOpt(ESI.ContactsApi, 'postCharactersCharacterIdContacts',
        [characterId, standing, contacts], opts, accessToken);
  };
  ...
  exports.add = function(characterId, contacts, standing, label, accessToken) {
    return bulkAddContacts(characterId, contacts, standing, false, label,
        accessToken);
  };
   ...
   * @esi_link ContactsApi.postCharactersCharacterIdContacts
   */
  exports.addWatched = function(characterId, contacts, standing, label,
      accessToken) {
    return bulkAddContacts(characterId, contacts, standing, true, label,
        accessToken);
  };

  var bulkUpdateContacts = function(characterId, contacts, standing, watched,
      label, accessToken) {
    var opts = { watched: watched };
    if (label) {
      opts.label = label;
    ...
    return newRequestOpt(ESI.ContactsApi, 'putCharactersCharacterIdContacts',
        [characterId, standing, contacts], opts, accessToken);
  };

  /**
   * Bulk update contacts to the same settings in the given character's contact
   * list via the ESI end point. This makes an HTTP PUT request to
   * [`/characters/{characterId}/contacts`](https://esi.tech.ccp.is/latest/#!/Contacts/put_characters_character_id_contacts).
   * The request is returned as an asynchronous Promise that resolves to an
   * empty object on success. The updated contacts are set to unwatched.
   *
   * @param {Integer} characterId The character id
   * @param {Array.<Integer>} contacts Array of contact character ids to add
   * @param {Float} standing The standing for all contacts
   * @param {Integer} label Optional; custom label id to add contacts to. If
   ...
   */
  exports.update = function(characterId, contacts, standing, label,
      accessToken) {
    return bulkUpdateContacts(characterId, contacts, standing, false, label,
        accessToken);
  };
   ...
   * [`/characters/{characterId}/contacts`](https://esi.tech.ccp.is/latest/#!/Contacts/put_characters_character_id_contacts).
   * The request is returned as an asynchronous Promise that resolves to an
   * empty object on success. The updated contacts are set to watched.
   *
   * @param {Integer} characterId The character id
   * @param {Array.<Integer>} contacts Array of contact character ids to add
   * @param {Float} standing The standing for all contacts
   ...
   * @esi_link ContactsApi.putCharactersCharacterIdContacts
   */
  exports.updateWatched = function(characterId, contacts, standing, label,
      accessToken) {
    return bulkUpdateContacts(characterId, contacts, standing, true, label,
        accessToken);
  };
  ...
  exports.getLabels = function(id, accessToken) {
    return newRequest(ESI.ContactsApi, 'getCharactersCharacterIdContactsLabels',
        [id], accessToken);
  };
