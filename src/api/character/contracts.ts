 ...
 */
export function makeContracts(agent: SSOAgent<number>): Contracts {
...
function getContracts(agent: SSOAgent<number>) {
  return agent.agent.request('get_characters_character_id_contracts',
      { path: { character_id: agent.id } }, agent.ssoToken);
}

function getContractItems(agent: SSOAgent<number>, id: number) {
  return agent.agent.request(
      'get_characters_character_id_contracts_contract_id_items',
      { path: { character_id: agent.id, contract_id: id } }, agent.ssoToken);
}

function getContractBids(agent: SSOAgent<number>, id: number) {
  return agent.agent.request(
