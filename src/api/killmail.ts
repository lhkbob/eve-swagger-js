...
export interface Killmail {
   ...
   */
  (id: number,
      hash: string): Promise<Responses['get_killmails_killmail_id_killmail_hash']>;
}
 ...
 */
export function makeKillmail(agent: ESIAgent): Killmail {
  return <Killmail> function (id: number, hash: string) {
