...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetMarketsPrices200Ok', 'model/GetMarketsPricesInternalServerError', 'model/GetMarketsRegionIdHistoryInternalServerError', 'model/GetMarketsRegionIdHistory200Ok', 'model/GetMarketsRegionIdHistoryUnprocessableEntity', 'model/GetMarketsRegionIdOrdersUnprocessableEntity', 'model/GetMarketsRegionIdOrders200Ok', 'model/GetMarketsRegionIdOrdersInternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetMarketsPrices200Ok'), require('../model/GetMarketsPricesInternalServerError'), require('../model/GetMarketsRegionIdHistoryInternalServerError'), require('../model/GetMarketsRegionIdHistory200Ok'), require('../model/GetMarketsRegionIdHistoryUnprocessableEntity'), require('../model/GetMarketsRegionIdOrdersUnprocessableEntity'), require('../model/GetMarketsRegionIdOrders200Ok'), require('../model/GetMarketsRegionIdOrdersInternalServerError'));
  } else {
...
}(this, function(ApiClient, GetMarketsPrices200Ok, GetMarketsPricesInternalServerError, GetMarketsRegionIdHistoryInternalServerError, GetMarketsRegionIdHistory200Ok, GetMarketsRegionIdHistoryUnprocessableEntity, GetMarketsRegionIdOrdersUnprocessableEntity, GetMarketsRegionIdOrders200Ok, GetMarketsRegionIdOrdersInternalServerError) {
  'use strict';
