...
function getTypeName(namespace, type) {
...
function titleToTypeName(namespace, title) {
    // First check explicit mapping for title
    if (type_overrides_1.TYPENAME_OVERRIDES[title]) {
        return [type_overrides_1.TYPENAME_OVERRIDES[title], true];
    }
