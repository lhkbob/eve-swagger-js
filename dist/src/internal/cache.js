...
class Cache {
     ...
     */
    constructor(defaultTTL = Number.POSITIVE_INFINITY) {
    ...
    static getExpirationTimestamp(e) {
        return Number.isFinite(e.expires) ? e.expires : undefined;
    }
    static isEntryValid(e, now) {
        return e.expires > now;
    }
    startCacheTimerMaybe(now, expirationTimestamp) {
        ...
        this.cacheTimer = setTimeout(() => this.cleanCache(), this.cacheCheckTimestamp - now);
