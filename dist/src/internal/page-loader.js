 ...
 */
function makePageBasedLoader(fetcher, pageSize) {
    return new PageLoader(fetcher, pageSize);
}
exports.makePageBasedLoader = makePageBasedLoader;
/**
 ...
 *    a response has fewer than this then continued fetching is ended
 */
function makeIDBasedLoader(fetcher, resolve, resultLength) {
    return new MaxIDLoader(fetcher, resolve, resultLength);
}
exports.makeIDBasedLoader = makeIDBasedLoader;
class PageLoader {
    constructor(fetch, pageLength) {
        this.fetch = fetch;
...
class MaxIDLoader {
    constructor(fetch, resolve, resultLength) {
        this.fetch = fetch;
