export declare namespace esi {
    ...
    namespace factionwarfare {
         ...
         */
        interface CharacterLeaderboard {
            /**
         ...
         */
        interface CorporationLeaderboard {
            /**
