...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkAttackers();
  });
  ...
  describe('GetKillmailsKillmailIdKillmailHashOkAttackers', function() {
    it('should create an instance of GetKillmailsKillmailIdKillmailHashOkAttackers', function() {
      // uncomment below and update the code to test GetKillmailsKillmailIdKillmailHashOkAttackers
      //var instane = new EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkAttackers();
      //expect(instance).to.be.a(EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkAttackers);
    });
