...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkPins();
  });
  ...
  describe('GetCharactersCharacterIdPlanetsPlanetIdOkPins', function() {
    it('should create an instance of GetCharactersCharacterIdPlanetsPlanetIdOkPins', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdPlanetsPlanetIdOkPins
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkPins();
      //expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkPins);
    });
