...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkVictim();
  });
  ...
  describe('GetKillmailsKillmailIdKillmailHashOkVictim', function() {
    it('should create an instance of GetKillmailsKillmailIdKillmailHashOkVictim', function() {
      // uncomment below and update the code to test GetKillmailsKillmailIdKillmailHashOkVictim
      //var instane = new EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkVictim();
      //expect(instance).to.be.a(EveSwaggerInterface.GetKillmailsKillmailIdKillmailHashOkVictim);
    });
