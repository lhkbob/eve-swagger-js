...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails();
  });
  ...
  describe('GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails', function() {
    it('should create an instance of GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails();
      //expect(instance).to.be.a(EveSwaggerInterface.GetCharactersCharacterIdPlanetsPlanetIdOkExtractorDetails);
    });
