...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} labelId Add a custom label to the contact, use 0 for clearing label
     * @param {Array.<module:model/Integer>} contactIds A list of contacts to edit
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
     ...
     */
    this.putCharactersCharacterIdContacts = function(characterId, standing, watched, labelId, contactIds, opts, callback) {
      opts = opts || {};
      var postBody = contactIds;
      ...
      // verify the required parameter 'watched' is set
      if (watched == undefined || watched == null) {
        throw "Missing the required parameter 'watched' when calling putCharactersCharacterIdContacts";
      }

      // verify the required parameter 'labelId' is set
      if (labelId == undefined || labelId == null) {
        throw "Missing the required parameter 'labelId' when calling putCharactersCharacterIdContacts";
      }
