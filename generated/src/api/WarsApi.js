...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetWarsInternalServerError', 'model/GetWarsWarIdOk', 'model/GetWarsWarIdUnprocessableEntity', 'model/GetWarsWarIdInternalServerError', 'model/GetWarsWarIdKillmails200Ok', 'model/GetWarsWarIdKillmailsInternalServerError', 'model/GetWarsWarIdKillmailsUnprocessableEntity'], factory);
    ...
    root.EveSwaggerInterface.WarsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetWarsInternalServerError, root.EveSwaggerInterface.GetWarsWarIdOk, root.EveSwaggerInterface.GetWarsWarIdUnprocessableEntity, root.EveSwaggerInterface.GetWarsWarIdInternalServerError, root.EveSwaggerInterface.GetWarsWarIdKillmails200Ok, root.EveSwaggerInterface.GetWarsWarIdKillmailsInternalServerError, root.EveSwaggerInterface.GetWarsWarIdKillmailsUnprocessableEntity);
  }
}(this, function(ApiClient, GetWarsInternalServerError, GetWarsWarIdOk, GetWarsWarIdUnprocessableEntity, GetWarsWarIdInternalServerError, GetWarsWarIdKillmails200Ok, GetWarsWarIdKillmailsInternalServerError, GetWarsWarIdKillmailsUnprocessableEntity) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} opts.page Which page to query, starting at 1, 2000 wars per page. (default to 1)
