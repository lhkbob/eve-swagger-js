...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.postUiAutopilotWaypoint = function(destinationId, clearOtherWaypoints, addToBeginning, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {module:model/PostUiOpenwindowNewmailNewMail} newMail The item type to open in market window
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.datasource The server name you would like data from (default to tranquility)
