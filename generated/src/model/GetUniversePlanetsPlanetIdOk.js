...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUniversePlanetsPlanetIdOkPosition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUniversePlanetsPlanetIdOkPosition'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.GetUniversePlanetsPlanetIdOk = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetUniversePlanetsPlanetIdOkPosition);
  }
}(this, function(ApiClient, GetUniversePlanetsPlanetIdOkPosition) {
  'use strict';
   ...
   * @param systemId {Integer} The solar system this planet is in
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('position')) {
        obj['position'] = GetUniversePlanetsPlanetIdOkPosition.constructFromObject(data['position']);
      }
  ...
  /**
   * @member {module:model/GetUniversePlanetsPlanetIdOkPosition} position
   */
