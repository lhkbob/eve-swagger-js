...
(function(root, factory) {
   ...
   * @class
   * @param constellations {Array.<Integer>} constellations array
   * @param name {String} name string
   * @param regionId {Integer} region_id integer
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('constellations')) {
        obj['constellations'] = ApiClient.convertToType(data['constellations'], ['Integer']);
      }
   ...
   * @member {Array.<Integer>} constellations
   */
